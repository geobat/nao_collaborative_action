...
/* ------------------------------ROS Nodes----------------------------------- */
/* -------------------------------------------------------------------------- */
// typedef actionlib::SimpleActionClient<exchange::ROSAction> Client;
...
// called once when the goal completes
	void doneCb(const actionlib::SimpleClientGoalState& state,
	            const exchange::ROSResultConstPtr& result);
// called once when the goal becomes active
	void activeCb();
// called every time feedback is received for the goal
	void feedbackCb(const exchange::ROSFeedbackConstPtr& feedback);
...
private:
	...
	bool finished_;
	bool received_;
	actionlib::SimpleActionClient<exchange::ROSAction> ac_;
