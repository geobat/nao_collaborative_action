...
//======>ici j'ai rajouté les name
		ros::ServiceClient client1 = n.serviceClient<exchange::BallPosForHead::Response>("ballposhead"+name);
		ros::ServiceClient client2 = n.serviceClient<exchange::BallPosForHand::Response>("ballposhand"+name);

		ros::spinOnce();

		//sends info on H for HSV to imageConverter
		exchange::BallPosForHead srv1;
		exchange::BallPosForHand srv2;
...
//======>idem, ici j'ai rajouté les name1 ppour préciser le serveur attaché
			...
			ros::ServiceClient client3 = n.serviceClient<exchange::BallPosForHead::Response>(headsrv);
			ros::ServiceClient client4 = n.serviceClient<exchange::BallPosForHand::Response>(handsrv);
