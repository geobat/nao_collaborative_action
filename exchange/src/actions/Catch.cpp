...
public:
	...
	std::string NAO_IP_p;
	int nao_p;
	exchange::GetArmReadyBT srv1;
	exchange::BallPosChangeBT srv2;
// member variables
...
int main(int argc, char** argv)
{
	if(argc != 1)
	{
		...
		ros::NodeHandle n;
		client1 = n.serviceClient<exchange::GetArmReadyBT::Response>("getArmReady");
		client2 = n.serviceClient<exchange::BallPosChangeBT::Response>("ballPosChange");
