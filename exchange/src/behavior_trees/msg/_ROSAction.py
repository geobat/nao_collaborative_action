"""autogenerated by genpy from behavior_trees/ROSAction.msg. Do not edit."""
import sys
...
class ROSAction(genpy.Message):
  _md5sum = "7dd4081a1e188ce1cb2005c5d0c2f4a1"
  _type = "behavior_trees/ROSAction"
...
================================================================================
MSG: behavior_trees/ROSActionGoal
...
================================================================================
MSG: behavior_trees/ROSGoal
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
#goal definition
int32 GOAL_

================================================================================
MSG: behavior_trees/ROSActionResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
...
================================================================================
MSG: behavior_trees/ROSResult
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
#result definition
int32 RESULT_

================================================================================
MSG: behavior_trees/ROSActionFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
...
================================================================================
MSG: behavior_trees/ROSFeedback
# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======
#feedback
int32 FEEDBACK_
...
"""
  ...
  _slot_types = ['behavior_trees/ROSActionGoal','behavior_trees/ROSActionResult','behavior_trees/ROSActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ROSAction, self).__init__(*args, **kwds)
      #message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = behavior_trees.msg.ROSActionGoal()
      if self.action_result is None:
        self.action_result = behavior_trees.msg.ROSActionResult()
      if self.action_feedback is None:
        self.action_feedback = behavior_trees.msg.ROSActionFeedback()
    else:
      self.action_goal = behavior_trees.msg.ROSActionGoal()
      self.action_result = behavior_trees.msg.ROSActionResult()
      self.action_feedback = behavior_trees.msg.ROSActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3I.pack(_x.action_goal.goal.GOAL_, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_struct_i3I.pack(_x.action_result.result.RESULT_, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.action_feedback.feedback.FEEDBACK_))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.GOAL_, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_result.result.RESULT_, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _struct_i3I.unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.action_feedback.feedback.FEEDBACK_,) = _struct_i.unpack(str[start:end])
      return self
