"""autogenerated by genpy from behavior_trees/ROSActionResult.msg. Do not edit."""
import sys
...
class ROSActionResult(genpy.Message):
  _md5sum = "c5601285c2afdd0cdc038d1e44ce6742"
  _type = "behavior_trees/ROSActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','behavior_trees/ROSResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ROSActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = behavior_trees.msg.ROSResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = behavior_trees.msg.ROSResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_struct_i.pack(self.result.RESULT_))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.result.RESULT_,) = _struct_i.unpack(str[start:end])
      return self
