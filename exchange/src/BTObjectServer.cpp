...
//public:
	...
	bool BTObjectServer::ballPosChange(exchange::BallPosChangeBT::Request &req,
	...
	bool BTObjectServer::ballPosGet(exchange::BallPosGetBT::Request &req,
	...
	bool BTObjectServer::armReady(exchange::ArmReadyBT::Request &req,
	...
	bool BTObjectServer::getArmReady(exchange::GetArmReadyBT::Request &req,
