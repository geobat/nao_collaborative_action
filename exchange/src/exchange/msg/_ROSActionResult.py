"""autogenerated by genpy from exchange/ROSActionResult.msg. Do not edit."""
import sys
...
class ROSActionResult(genpy.Message):
  ...
  _type = "exchange/ROSActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','exchange/ROSResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = exchange.msg.ROSResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = exchange.msg.ROSResult()
