...
(cl:defmethod cl:initialize-instance :after ((m <GetArmReadyBT-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetArmReadyBT-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exchange-srv:<GetArmReadyBT-request> is deprecated: use exchange-srv:GetArmReadyBT-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <GetArmReadyBT-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetArmReadyBT-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exchange-srv:<GetArmReadyBT-response> is deprecated: use exchange-srv:GetArmReadyBT-response instead.")))

(cl:ensure-generic-function 'arm-val :lambda-list '(m))
(cl:defmethod arm-val ((m <GetArmReadyBT-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exchange-srv:arm-val is deprecated.  Use exchange-srv:arm instead.")
  (arm m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GetArmReadyBT-response>)))
  ...
  "exchange/GetArmReadyBTResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GetArmReadyBT-response)))
  "Returns string type for a service object of type 'GetArmReadyBT-response"
  "exchange/GetArmReadyBTResponse")
