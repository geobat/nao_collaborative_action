...
(cl:defmethod cl:initialize-instance :after ((m <BallPosGetBT-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BallPosGetBT-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exchange-srv:<BallPosGetBT-request> is deprecated: use exchange-srv:BallPosGetBT-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <BallPosGetBT-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BallPosGetBT-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exchange-srv:<BallPosGetBT-response> is deprecated: use exchange-srv:BallPosGetBT-response instead.")))
