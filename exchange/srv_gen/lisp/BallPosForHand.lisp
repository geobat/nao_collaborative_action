...
(cl:defmethod cl:initialize-instance :after ((m <BallPosForHand-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BallPosForHand-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exchange-srv:<BallPosForHand-request> is deprecated: use exchange-srv:BallPosForHand-request instead.")))

(cl:ensure-generic-function 'min_h-val :lambda-list '(m))
(cl:defmethod min_h-val ((m <BallPosForHand-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exchange-srv:min_h-val is deprecated.  Use exchange-srv:min_h instead.")
  (min_h m))

(cl:ensure-generic-function 'max_h-val :lambda-list '(m))
(cl:defmethod max_h-val ((m <BallPosForHand-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exchange-srv:max_h-val is deprecated.  Use exchange-srv:max_h instead.")
  (max_h m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BallPosForHand-request>)))
  ...
  "exchange/BallPosForHandRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BallPosForHand-request)))
  "Returns string type for a service object of type 'BallPosForHand-request"
  "exchange/BallPosForHandRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <BallPosForHand-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BallPosForHand-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exchange-srv:<BallPosForHand-response> is deprecated: use exchange-srv:BallPosForHand-response instead.")))

(cl:ensure-generic-function 'pos_x-val :lambda-list '(m))
(cl:defmethod pos_x-val ((m <BallPosForHand-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exchange-srv:pos_x-val is deprecated.  Use exchange-srv:pos_x instead.")
  (pos_x m))

(cl:ensure-generic-function 'pos_y-val :lambda-list '(m))
(cl:defmethod pos_y-val ((m <BallPosForHand-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exchange-srv:pos_y-val is deprecated.  Use exchange-srv:pos_y instead.")
  (pos_y m))

(cl:ensure-generic-function 'pos_z-val :lambda-list '(m))
(cl:defmethod pos_z-val ((m <BallPosForHand-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader exchange-srv:pos_z-val is deprecated.  Use exchange-srv:pos_z instead.")
  (pos_z m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BallPosForHand-response>)))
  ...
  "exchange/BallPosForHandResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BallPosForHand-response)))
  "Returns string type for a service object of type 'BallPosForHand-response"
  "exchange/BallPosForHandResponse")
