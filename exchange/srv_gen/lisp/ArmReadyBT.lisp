...
(cl:defmethod cl:initialize-instance :after ((m <ArmReadyBT-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArmReadyBT-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exchange-srv:<ArmReadyBT-request> is deprecated: use exchange-srv:ArmReadyBT-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <ArmReadyBT-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArmReadyBT-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name exchange-srv:<ArmReadyBT-response> is deprecated: use exchange-srv:ArmReadyBT-response instead.")))
